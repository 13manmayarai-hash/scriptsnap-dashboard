  ...
  return (
    <section className="py-5 sm:py-7">
      <div className="mx-auto max-w-[1240px] px-[18px] sm:px-6 lg:px-12">
        <Reveal>
          <div className="flex flex-col items-center gap-4 overflow-visible rounded-[24px] border border-warm-border bg-warm-tint p-8 text-center md:flex-row md:items-end md:justify-between md:gap-32 md:pb-5 md:pt-0 md:pl-8 md:pr-11 md:text-left">
