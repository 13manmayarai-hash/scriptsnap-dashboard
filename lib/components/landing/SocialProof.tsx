  ...
  return (
    <section className="py-10 sm:py-14">
      <div className="mx-auto max-w-[1240px] px-[18px] sm:px-6 lg:px-12">
        <Reveal>
          <div className="rounded-[20px] border border-warm-border bg-warm-tint p-6 sm:p-9">
            <h2 className="mx-auto mb-7 max-w-[560px] text-center font-serif text-[clamp(1.6rem,3vw,2.1rem)] font-semibold leading-tight tracking-[-0.01em] text-ink">
