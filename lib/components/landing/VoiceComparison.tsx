  ...
  return (
    <section className="py-10 sm:py-14">
      <div className="mx-auto max-w-[1240px] px-[18px] sm:px-6 lg:px-12">
        <Reveal>
          <div className="grid grid-cols-1 items-stretch gap-4 rounded-[20px] border border-warm-border bg-warm-surface-alt p-6 sm:grid-cols-[1fr_44px_1fr_1fr] sm:p-8">
            ...
            <ArrowRight size={22} className="mx-auto flex-shrink-0 self-center rotate-90 text-ink-faint sm:rotate-0" aria-hidden="true" />
            ...
            <div className="rounded-xl border border-warm-border bg-warm-surface p-5">
              <h3 className="text-[13px] font-semibold text-ink">Creator Voice</h3>
              <div className="mt-3 flex flex-col gap-2.5">
                {CREATOR_VOICE_TRAITS.map((trait) => (
                  <div key={trait.label} className="flex items-center justify-between text-[12.5px] text-ink-muted">
              ...
              <Link href="/dashboard/settings" className="btn-secondary mt-3 w-full !rounded-full text-[12.5px]">
